...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('news', '0004_articletranslation_event_language'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='event_download_url',
            field=models.URLField(null=True, max_length=255, blank=True, help_text='Link to downloadable file, e.g. event programme'),
        ),
        migrations.AddField(
            model_name='article',
            name='event_language',
        ...
        migrations.AddField(
            model_name='article',
            name='event_organiser',
            field=models.ForeignKey(null=True, to='institutions.Institution', blank=True),
        ),
        migrations.AddField(
            model_name='article',
            name='event_website_url',
